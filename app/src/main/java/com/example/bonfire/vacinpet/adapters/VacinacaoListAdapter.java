...
public class VacinacaoListAdapter extends ArrayAdapter<Vacinacao> {

    private Context mContext;
    private int mResource;

    public VacinacaoListAdapter(Context context, int resource, List<Vacinacao> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(getItem(position).getVacina() != null){
            ...
            TextView textView = (TextView) convertView.findViewById(R.id.txtNomeVacina);
            textView.setText(getItem(position).getVermifugo().getNomevermi());
        }
